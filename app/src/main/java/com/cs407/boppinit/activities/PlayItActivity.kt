...
import com.cs407.boppinit.databinding.FragmentPlayItBinding

class PlayItActivityView(
    private val onComplete: () -> Unit,
    private val difficulty: Difficulty
) : Fragment(), BopItActivityView {
    private var _binding: FragmentPlayItBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentPlayItBinding.inflate(inflater, container, false)
        return binding.root
    }
